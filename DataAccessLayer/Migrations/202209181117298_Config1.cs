    ...
    public partial class Config1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Writers", t => t.WriteID)
                .Index(t => t.HeadingID)
                .Index(t => t.WriteID);
            ...
            CreateTable(
                ...
                c => new
                    {
                        WriteID = c.Int(nullable: false, identity: true),
        ...
        {
            DropForeignKey("dbo.Headings", "WriteID", "dbo.Writers");
            ...
            DropIndex("dbo.Headings", new[] { "WriteID" });
